...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!token) {
        throw new Error("Registration successful, but no token was returned.");
      }

      // Save token so authenticated API requests work
      ...
      // User is already logged in, so don't send them back to login
      navigate("/");
    } catch (error) {
